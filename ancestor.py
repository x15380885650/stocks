...
class Ancestor(object):
    ...
    def is_trade(self):
        ...
        end_time_1 = datetime(now.year, now.month, now.day, 10, 15)

        start_time_2 = datetime(now.year, now.month, now.day, 11, 27)
        end_time_2 = datetime(now.year, now.month, now.day, 13, 3)

        start_time_3 = datetime(now.year, now.month, now.day, 14, 10)
